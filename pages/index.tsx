...
const Products = () => {
  ...
  const tools = [
    ...
    { id: "calculator", enable: false, name: "Calculadora", description: "Uma calculadora simples e eficiente.", icon: <Calculator size={20} />, link: "/calculator" },
    { id: "password", enable: false, name: "Gerador de senha segura", description: "Encurte links longos para facilitar o compartilhamento.", icon: <SquareAsteriskIcon size={20} />, link: "/password" },
  ];
    ...
    <div className="flex h-screen bg-blue-50">
      ...
      <div className="w-3/4 p-10 flex flex-col items-start justify-center text-left">
          ...
          <div className="mt-6 flex flex-row gap-4">
            <div>
              ...
              <div className="mt-6 flex gap-4">
                <a href={selectedTool.link} className="px-6 py-3 bg-violet-700 text-white rounded-lg hover:bg-violet-500 transition">
                  Acessar
                </a>
                <button
                  className="px-6 py-3 bg-violet-700 text-white rounded-lg hover:bg-violet-500 transition"
        ...
        <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <h2 className="text-2xl font-bold text-violet-700">Funcionalidades:</h2>
