...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto p-6 flex flex-col items-center text-center">
      <h1 className="text-3xl font-bold mb-4">Ferramentas</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
        {tools.map((tool) => (
          <div key={tool.id} className="border p-6 rounded-lg shadow-md w-80 h-64 flex flex-col items-center text-center">
      ...
      <Dialog open={!!selectedTool} onClose={() => setSelectedTool(null)} tool={selectedTool} />
    </div>
  );
}
