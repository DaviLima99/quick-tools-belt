                            ...
                            <div>
                                <div className="flex space-x-4 mb-4">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded transition-colors duration-300 ${inputType === 'url' ? 'bg-white text-slate-900 border-2 border-slate-900' : 'bg-gray-200'
                                            }`}
                                    >
                                        URL
                                    </button>
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded transition-colors duration-300 ${inputType === 'text' ? 'bg-white text-slate-900 border-2 border-slate-900' : 'bg-gray-200'
                                            }`}
                                    >
                                        Texto
                                    </button>
