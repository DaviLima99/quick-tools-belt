...
const Products = () => {
  ...
  const tools = [
    ...
    },
    {
      ...
      details: {
        ...
        description: "Nossa calculadora é uma ferramenta prática e fácil de usar para realizar cálculos básicos e avançados. Com uma interface intuitiva e funcionalidades avançadas, você pode realizar cálculos de forma rápida e precisa.",
        features: [
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-violet-600 pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
        <div className="containermx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full p-4">
              <div className="mx-auto max-w-[800px] text-center">
                <div className="flex p-3 mb-3 justify-center rounded-full space-x-4">
                  {
                    tools.map((tool) => (
                      <button
                        id={tool.id}
                        ...
                        className={`flex items-center justify-center rounded-full px-6 py-3 transition-colors duration-300 
                                                ${selectedTool.id == tool.id ? 'bg-violet-500 text-white shadow-lg' : 'text-violet-400 bg-white'
                          }`}
                      >
                        {tool.icon}
                        {tool.name}
                ...
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  {selectedTool.details.title}
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  {selectedTool.details.description}
                </p>
